...
Several direct-search methods appeared after the work of \citeauthor{Fermi_Metropolis_1952}.
...
A graphical representation of the data profiles of the experiment described in \cref{subsec:performance-profiles} is given in~\cref{fig:data-profile-example}.

\begin{figure}[ht]
    \centering
    \drawdataprofiles{{"NEWUOA","BFGS","CG"}}{plain-1-50-data-bfgs-cg-newuoa-U.csv}{5}
    \caption{Example of data profiles}
