...
In particular, we introduce the Lagrange quadratic polynomials, as these polynomials underlie a notion of well-poisedness referred to as the~$\Lambda$-poisedness, also presented in this chapter.
At the end of this chapter, we study a particular interpolation set proposed by \citeauthor{Powell_2001}~\cite{Powell_2001}, showing that this set is, in some sense, optimal.
