...
% We now introduce the underdetermined interpolation scheme that is the most important for us, as it is at the heart of the \gls{dfo} method we develop in \cref{ch:cobyqa-introduction}.
