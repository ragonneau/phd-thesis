...
Therefore, \cref{thm:sqp-path} reveals that the objective function of the \gls{sqp} subproblem is
a natural approximation of~$\obj$ in this tangent space if we regard $\obj$ as a function
on~$\mathcal{S}_{\bar{\iter}}$.
