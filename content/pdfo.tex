...
\index{NEWUOA@\glsfmttext{newuoa}|(}\index{BOBYQA@\glsfmttext{bobyqa}|(}\index{LINCOA@\glsfmttext{lincoa}|(}\Gls{newuoa}~\cite{Powell_2006} was designed as a successor to \gls{uobyqa}.
...
As long as these constraints are consistent, we reformulate~\cref{eq:pdfo} into a~$(n - \rank A_{\scriptscriptstyle\ieq})$\nomenclature[Om]{$\rank$}{Rank operator}-dimensional problem by eliminating these linear equality constraints.
