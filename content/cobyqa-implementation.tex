...
\Cref{lst:cobyqa-rosenbrock} shows how to solve such a problem with~$n = 5$ using \gls{cobyqa}, starting from the initial guess~$\iter[0] = [1.3, 0.7, 0.8, 1.9, 1.2]^{\T}$.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Performance profiles of \gls{cobyqa} and a modified version on  and nonlinearly constrained problems with at least one inequality constraint}
...
In this section, we compare the performance of \gls{cobyqa}, \gls{newuoa}, and \gls{cobyla} on unconstrained problems.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Performance profiles of \gls{cobyqa}, \gls{newuoa}, and \gls{cobyla} on unconstrained problems}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Data profiles of \gls{cobyqa}, \gls{newuoa}, and \gls{cobyla} on unconstrained problems}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Performance profiles of \gls{cobyqa}, \gls{bobyqa}, and \gls{cobyla} on bound-constrained problems}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Data profiles of \gls{cobyqa}, \gls{bobyqa}, and \gls{cobyla} on bound-constrained problems}
...
For~$\tau = 10^{-1}$, \gls{cobyqa} solves more problems than \gls{cobyla}, the percentages being about \SI{98}{\percent} and \SI{91}{\percent}.
...
Finally, for~$\tau = 10^{-1}$, the two methods perform similarly.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Performance profiles of \gls{cobyqa}, \gls{lincoa}, and \gls{cobyla} on linearly constrained problems}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Data profiles of \gls{cobyqa}, \gls{lincoa}, and \gls{cobyla} on linearly constrained problems}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Performance profiles of \gls{cobyqa}, \gls{lincoa}, and \gls{cobyla} on linearly constrained problems with inviolable bounds}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Data profiles of \gls{cobyqa}, \gls{lincoa}, and \gls{cobyla} on linearly constrained problems with inviolable bounds}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Performance profiles of \gls{cobyqa} and \gls{cobyla} on nonlinearly constrained problems}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Data profiles of \gls{cobyqa} and \gls{cobyla} on nonlinearly constrained problems}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Performance profiles of \gls{cobyqa} and \gls{cobyla} on nonlinearly constrained problems with inviolable bounds}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Data profiles of \gls{cobyqa} and \gls{cobyla} on nonlinearly constrained problems with inviolable bounds}
    \label{fig:data-nonlinearly-constrained-problems-bounds}
\end{figure}

The results are similar to the ones in \cref{fig:perf-nonlinearly-constrained-problems,fig:data-nonlinearly-constrained-problems}, altough the advantage of \gls{cobyqa} over \gls{cobyla} becomes even more visible.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Performance profiles of \gls{cobyqa} and \gls{cobyla} on all types of problems}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
    \caption{Data profiles of \gls{cobyqa} and \gls{cobyla} on all types of problems}
