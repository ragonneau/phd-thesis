...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-2"}}{plain-1-50-perf-cobyqa-byrd-omojokun-nlqo.csv}{1}
        \caption{Tolerance~$\tau = 10^{-1}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-2"}}{plain-1-50-perf-cobyqa-byrd-omojokun-nlqo.csv}{3}
        \caption{Tolerance~$\tau = 10^{-3}$}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-2"}}{plain-1-50-perf-cobyqa-byrd-omojokun-nlqo.csv}{5}
        \caption{Tolerance~$\tau = 10^{-5}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-2"}}{plain-1-50-perf-cobyqa-byrd-omojokun-nlqo.csv}{7}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-2"}}{plain-1-50-perf-cobyqa-wrong-hessian-qo.csv}{1}
        \caption{Tolerance~$\tau = 10^{-1}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-2"}}{plain-1-50-perf-cobyqa-wrong-hessian-qo.csv}{3}
        \caption{Tolerance~$\tau = 10^{-3}$}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-2"}}{plain-1-50-perf-cobyqa-wrong-hessian-qo.csv}{5}
        \caption{Tolerance~$\tau = 10^{-5}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-2"}}{plain-1-50-perf-cobyqa-wrong-hessian-qo.csv}{7}
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-no","COBYQA-always"}}{plain-1-50-perf-cobyqa-models-ubnlqo.csv}{1}
        \caption{Tolerance~$\tau = 10^{-1}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-no","COBYQA-always"}}{plain-1-50-perf-cobyqa-models-ubnlqo.csv}{3}
        \caption{Tolerance~$\tau = 10^{-3}$}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-no","COBYQA-always"}}{plain-1-50-perf-cobyqa-models-ubnlqo.csv}{5}
        \caption{Tolerance~$\tau = 10^{-5}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \drawperformanceprofiles{{"COBYQA","COBYQA-no","COBYQA-always"}}{plain-1-50-perf-cobyqa-models-ubnlqo.csv}{7}
        \caption{Tolerance~$\tau = 10^{-7}$}
    \end{subfigure}
