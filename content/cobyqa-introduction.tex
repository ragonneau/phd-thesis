...
% A important characteristic of \gls{cobyqa} is that it never attempts to visits points lying outside of bound constraints.
...
\todo[noline]{Summarize the simple constraints}
