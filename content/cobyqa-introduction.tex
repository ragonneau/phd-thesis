...
\begin{algorithm}
    ...
    \For{$k = 0, 1, \dots$ until convergence}{
        ...
        Update the trust-region radius~$\rad[k + 1]$\; \label{alg:derivative-free-trust-region-sqp-radius}
