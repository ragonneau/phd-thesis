...
An important feature of \gls{cobyqa} is that it never attempts to visits points lying outside of the bounds.
...
% Moreover, it tackles the bound constraints using an active-set approach.
...
% Finally, the current implementation of \gls{sqpdfo} encounters internal errors when solving , particularly on Line 494, in \texttt{sqpdfo\_prelim\_}.
