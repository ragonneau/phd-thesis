...
In this section, we detail the geometry-improving procedure of \gls{cobyqa}, corresponding to \cref{alg:derivative-free-trust-region-sqp-geometry} of \cref{alg:derivative-free-trust-region-sqp}\todo[color=OliveGreen!50]{Adapt the presentation of the geometry-improving step}.
...
% The optimization method terminates if it reaches a given final value.
...
% In particular, since geometry-improving points are included in the interpolation set, the method ensures that they also respect the bounds.
