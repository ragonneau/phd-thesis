...
\Cref{sec:cobyqa-lagrange-multipliers} establishes an elementary variation of the \gls{nnls} algorithm~\cite[Alg.~(23.10)]{Lawson_Hanson_1987}, used to solve the least-squares problem~\cref{eq:least-squares-lagrange-multipliers-cobyqa} for estimating the Lagrange multiplier in \gls{cobyqa}.
...
\index{TCG@\glsfmtshort{tcg}|(}Therefore, in trust-region method, we solve~\cref{eq:problem-tcg} approximately.
...
The \gls{tcg} method underlies the subproblem solvers employed by \gls{cobyqa}, as presented hereinafter.\index{TCG@\glsfmtshort{tcg}|)}
