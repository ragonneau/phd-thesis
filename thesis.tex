...
\DTMsavedate{ini}{2022-08-12}  % date of creation
\DTMsavedate{rev}{2022-08-12}  % date of revision
\date{\DTMusedate{ini}}
\newcommand{\degree}{Doctor of Philosophy}
\newcommand{\university}{The Hong Kong Polytechnic University}
\newcommand{\department}{Department of Applied Mathematics}

% \includeonly{content/abstract,content/conclusion}
% \includeonly{content/pdfo}
% \includeonly{content/cobyqa-introduction}
% \includeonly{content/cobyqa-subproblems}
% \includeonly{content/cobyqa-implementation,content/experiments}
