...
\fancypagestyle{main}{
    ...
    \fancyfoot[OR]{
        ...
        \rightmark\hspace*{1pc}{\color{NavyBlue}\rule[-18.48mm]{1.25pt}{21.98mm}}\hspace*{10pt}%
        \begin{minipage}[b]{1.5cm}
            \normalsize\textbf{\thepage}
        \end{minipage}%
    }
...
\titleformat{\chapter}[display]
    ...
    {\raggedleft\vspace{-\dimexpr\baselineskip+33.48mm\relax}\color{NavyBlue}%
        \rule[-2mm]{2pt}{45.48mm}\quad\fontsize{60}{60}\selectfont\thechapter}
    {-12mm}
