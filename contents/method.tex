...
We are not interested in this study in finding global minimizer (if any) of problem~\eqref{eq:nlcp}, as such a problem is tremendously difficult, even in gradient-based settings.
We are rather interested in finding stationary points of problem~\eqref{eq:nlcp}, as defined below.
